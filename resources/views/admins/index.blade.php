...
<body class="flex flex-col h-screen">
    ...
    <main>
        <div class="flex-1 flex-col w-full mt-5 bg-cover bg-center"
            style="background-image: url('img blades/headadminpage.jpg'); margin-top: 50px;">
    ...
    <main class="bg-cover bg-center"
        style="background-image: url('img blades/coveradmin.jpg'); background-attachment: fixed;">
