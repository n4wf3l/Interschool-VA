  ...
  <main class="bg-white flex-1 pt-20">
    <ol class="flex items-center w-full text-sm font-medium text-center text-gray-500 dark:text-gray-400 sm:text-base">
      <li
        ...
        <span
          ...
          <span class="me-2"><button type="button" onclick="window.location.href='{{ route('registerteams') }}'"
      ...
      <li
        class="text-red-500 flex md:w-full items-center text-gray-500 dark:text-blue-500 sm:after:content-[''] after:w-full after:h-1 after:border-b after:border-gray-200 after:border-1 after:hidden sm:after:inline-block after:mx-6 xl:after:mx-10 dark:after:border-gray-700 hover:text-teal-500 duration-500">
        <span
    ...
    <div class="bg-gray-100 p-8 md:p-0 md:flex md:items-center md:justify-evenly p-10">
      <div class="mx-auto md:mx-0 items-center">
        <img src="{{ asset('img blades/balimg.jpg') }}" alt="Votre Image" class="w-50 h-70">
      </div>
      <div>
        ...
        <form class="max-w-sm mx-auto pb-8" method="POST" action="{{ route('register') }}">
          ...
          <div class="mb-5">
            <label for="surname" :value="__('Familienaam')"
          ...
          <div class="mb-5">
            <label for="password_confirmation" :value="__('Bevestig Wachtwoord')"
              class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Bevestig wachtwoord</label>
          ...
          <div class="mb-5 md:mb-0">
            ...
            <div class="flex flex-row items-center">
              ...
              <label for="aanvoerder_yes"
                class="block ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Ja</label>
            </div>
            <div class="flex flex-row items-center">
              <input id="aanvoerder_no" type="radio" name="teamleader" value="0" checked
                class="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300 dark:focus:ring-blue-600 dark:focus:bg-blue-600 dark:bg-gray-700 dark:border-gray-600">
              <label for="aanvoerder_no"
                class="block ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Nee</label>
            </div>
          </div>
          ...
          <div class="mb-5 md:mb-0 pt-5">
            ...
            <div class="flex flex-row items-center">
              <input id="reservespeler_yes" type="radio" name="reserveplayer" value="1"
                class="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300 dark:focus:ring-blue-600 dark:focus:bg-blue-600 dark:bg-gray-700 dark:border-gray-600">
              <label for="reservespeler_yes"
                class="block ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Ja</label>
            </div>
            <div class="flex flex-row items-center">
              <input id="reservespeler_no" type="radio" name="reserveplayer" value="0" checked
                class="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300 dark:focus:ring-blue-600 dark:focus:bg-blue-600 dark:bg-gray-700 dark:border-gray-600">
              <label for="reservespeler_no"
                class="block ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Nee</label>
            </div>
          </div>
      </div>

      <div class=" md:flex-row justify-center mb-6 text-center">
        <a class="pr-6 text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 ml-5"
          href="{{ route('login') }}">
          {{ __('Al ingeschreven?') }}
        </a>
